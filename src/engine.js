...
function init(htmlCanvasID) {
    ...
    let canvas = document.getElementById(htmlCanvasID);
    let gameContainer = document.getElementById("game__container_hud");
    
    let gameContainerHUD = document.getElementById("gameHUD-data")
    gameContainer.insertBefore(gameContainerHUD, gameContainer.firstChild);
